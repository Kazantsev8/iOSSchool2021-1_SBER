...
let manager = Responder(qa: [
    "I wanna refresh profile info": "Let's get on with it"
])

let expert = Responder(qa: [
    "Very specific tech question": "Very specific tech answer"
])
...
callCenter.receiveCall(question: "I wanna refresh profile info")
